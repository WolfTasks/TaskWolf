...
i18n
  ...
  .init({
    resources: {
      en: { common: enCommon, settings: enSettings, nav: enNav, auth: enAuth, issues: enIssues, 'issues-fields': enIssuesFields, comments: enComments, board: enBoard, backlog: enBacklog, sprints: enSprints, dashboard: enDashboard, reports: enReports, notifications: enNotifications, projects: enProjects, 'project-settings': enProjectSettings, workflow: enWorkflow, automation: enAutomation, admin: enAdmin, servicedesk: enServicedesk, orgs: enOrgs },
      de: { common: deCommon, settings: deSettings, nav: deNav, auth: deAuth, issues: deIssues, 'issues-fields': deIssuesFields, comments: deComments, board: deBoard, backlog: deBacklog, sprints: deSprints, dashboard: deDashboard, reports: deReports, notifications: deNotifications, projects: deProjects, 'project-settings': deProjectSettings, workflow: deWorkflow, automation: deAutomation, admin: deAdmin, servicedesk: deServicedesk, orgs: deOrgs },
    },
    fallbackLng: 'en',
    supportedLngs: [...SUPPORTED_LANGUAGES],
    nonExplicitSupportedLngs: true,
    defaultNS: 'common',
    ns: ['common', 'settings', 'nav', 'auth', 'issues', 'issues-fields', 'comments', 'board', 'backlog', 'sprints', 'dashboard', 'reports', 'notifications', 'projects', 'project-settings', 'workflow', 'automation', 'admin', 'servicedesk', 'orgs'],
